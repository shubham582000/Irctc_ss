...
const SpecialTrain=()=>{
    ...
    const fetchUrl=requests.fetchSpecial;
    useEffect(()=>{
    ...
    return (
        <div className="specialName">
            ...
            <div className="divi" style={{backgroundColor:"green",display:"flex",width:"40%" ,textAlign:"center",margin:"10px",border:"solid black 6px",borderRadius:"20px"}} ><h1 style={{color:"white",padding:"4px",textAlign:"center"}} >Specials Trains</h1>
</div>
